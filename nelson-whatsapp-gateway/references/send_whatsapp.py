...
Uso:
  ...
  python3 send_whatsapp.py --to pablo,terian --message "Broadcast"
"""
...
# Directorio de contactos del equipo Nelson
CONTACTS = {
    "pablo": "5493816240691",
...
def main():
    ...
    parser.add_argument("--to", required=True, help="Número(s) o nombre(s) destino. Ej: 5493816240691, pablo, terian")
    parser.add_argument("--message", required=True, help="Mensaje a enviar")
    parser.add_argument("--batch", action="store_true", help="Usar modo batch")
    parser.add_argument("--delay", type=int, default=2000, help="Delay entre mensajes en ms")
