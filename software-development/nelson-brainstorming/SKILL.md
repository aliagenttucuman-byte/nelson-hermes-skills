...
- `references/powerbi-public-embed-scraping.md` — Técnica Playwright para extraer datos de embeds públicos de Power BI sin Azure AD. Parser DSR, pitfalls, diferencias vs CSV directo, roadmap para Power BI corporativo YPF.
